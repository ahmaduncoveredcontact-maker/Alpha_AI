  ...
  const downloadCard = async () => {
    ...
    try {
      const canvas = await html2canvas(cardRef.current, {
        scale: 3, // Increased scale for sharper print quality
        useCORS: true,
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
      <div
        ...
        style={{
          width: '400px',
          height: '580px',
          padding: '40px 32px', // Balanced symmetric padding
      ...
      >
        {/* Business name with Signature Style */}
        <div style={{ textAlign: 'center', width: '100%' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
            <span style={{ color: '#9ca3af', fontSize: '18px' }}>✦</span>
            <h3 style={{
              fontFamily: "'Dancing Script', 'Great Vibes', 'Brush Script MT', 'Lucida Handwriting', cursive",
              fontSize: '40px', // Larger size for cursive readability
              fontWeight: 500,
              color: '#1a1a2e', // Solid color prevents html2canvas black box bug
              margin: 0,
              lineHeight: 1.2,
            }}>
        ...
        {/* QR Code with increased breathing room */}
        <div style={{ display: 'flex', justifyContent: 'center', width: '100%', padding: '20px 0' }}>
          {loading ? (
            ...
            <img
              src={qrDataUrl}
              alt="QR Code"
              style={{ width: '224px', height: '224px', objectFit: 'contain', border: '2px solid #f3f4f6', borderRadius: '16px', padding: '12px', backgroundColor: '#ffffff', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.05)' }}
            />
          ) : (
            <div style={{ width: '224px', height: '224px', backgroundColor: '#f3f4f6', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#9ca3af', border: '2px dashed #d1d5db' }}>
              No QR
        ...
        <div style={{ textAlign: 'center', width: '100%' }}>
          ...
          <div style={{ marginBottom: '4px' }}>
            <span style={{ fontSize: '18px', fontWeight: 500, color: '#4b5563' }}>Google</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'center', fontSize: '20px', color: '#eab308', marginBottom: '8px' }}>
            <span>&#9733;</span><span>&#9733;</span><span>&#9733;</span><span>&#9733;</span><span>&#9733;</span>
          </div>
          <p style={{ fontSize: '15px', fontWeight: 600, color: '#374151', margin: '0 0 6px 0', letterSpacing: '0.02em' }}>
            {title}
          </p>
